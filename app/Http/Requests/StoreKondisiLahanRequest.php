...
class StoreKondisiLahanRequest extends FormRequest
{
    ...
    /**
     * Validasi tambahan: tanggal pemupukan terakhir <= tanggal observasi,
     * tanggal observasi tidak sebelum tahun tanam.
     */
    ...
    private function validateDates($validator): void
    {
        ...
        // Validasi: tanggal_pemupukan_terakhir <= tanggal_observasi
        ...
        // Validasi: tanggal_observasi tidak sebelum tahun tanam
