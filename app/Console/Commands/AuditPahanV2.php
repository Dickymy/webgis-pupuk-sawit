...
class AuditPahanV2 extends Command
{
    ...
    public function handle(): int
    {
        ...
        if ($blokUmur3 > 0) {
            $issues[] = "Ada {$blokUmur3} blok umur 3 tahun perlu verifikasi fase";
        }
        ...
        if ($rekTanpaVersi > 0) {
            $issues[] = "Ada {$rekTanpaVersi} rekomendasi tanpa versi mesin";
        }
        ...
        if ($rekLatestLegacy > 0) {
            $issues[] = "Ada {$rekLatestLegacy} rekomendasi aktif masih versi legacy-v1";
        }
