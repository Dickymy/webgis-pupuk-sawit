                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                        ...
                        <input type="number" name="curah_hujan_mm_bulanan" id="curah_hujan_mm_bulanan"
                            value="{{ old('curah_hujan_mm_bulanan', $kondisiLahan->curah_hujan_mm_bulanan) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="periode_curah_hujan" id="periode_curah_hujan"
                            value="{{ old('periode_curah_hujan', $kondisiLahan->periode_curah_hujan) }}"
                    ...
                    <div>
                        ...
                        @include('components.custom-select', [
                            ...
                            'selected'=> old('sumber_curah_hujan', $kondisiLahan->sumber_curah_hujan),
                            'placeholder' => '— Pilih —',
                        ])
                    </div>
                </div>
    ...
    window.fetchCuacaOtomatis = function() {
        ...
        .then(function(data) {
            ...
            if (data.success) {
                ...
                // Auto-fill field presisi curah hujan (Pahan-v2)
