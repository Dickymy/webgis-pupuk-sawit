            ...
            <div class="border-t border-slate-100 pt-5 mt-5">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-6 mb-4">
                    <label class="flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
                        <input type="radio" name="mode_populasi" value="otomatis" class="text-emerald-600 focus:ring-emerald-500 w-4 h-4" onchange="togglePopulasiMode('otomatis')" {{ old('jumlah_pohon') ? '' : 'checked' }}>
                        <span class="font-medium">Otomatis (Berdasarkan Luas × SPH)</span>
                    </label>
                    <label class="flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
                        <input type="radio" name="mode_populasi" value="manual" class="text-emerald-600 focus:ring-emerald-500 w-4 h-4" onchange="togglePopulasiMode('manual')" {{ old('jumlah_pohon') ? 'checked' : '' }}>
                        <span class="font-medium">Input Manual (Jumlah Pohon Aktual)</span>
                    </label>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div id="populasi_otomatis_wrapper" style="display: {{ old('jumlah_pohon') ? 'none' : 'block' }}">
                    ...
                    <div id="populasi_manual_wrapper" style="display: {{ old('jumlah_pohon') ? 'block' : 'none' }}">
                        ...
                        <input type="number" id="jumlah_pohon" name="jumlah_pohon" value="{{ old('jumlah_pohon') }}" min="1" placeholder="Misal: 270"
...
// Trigger preview pada saat halaman dimuat (untuk old data)
